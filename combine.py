...
if __name__ == '__main__':
    ...
    # src_file = "../WN18RR-hp/noun/src-path-valid.txt"
    # tgt_file = "../WN18RR-hp/noun/tgt-path-valid.txt"
    # pred_file = "pred.txt"
    # epochs = 70
    # category = "nouns"  # verbs, nouns or instnouns
    ...
    tgtval = [i.split(' ')[-1].strip() for i in tgtval]
